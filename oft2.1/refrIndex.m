...
% LAMBDA is in microns. Calculates refractive index for fused silica.
%
...
n = sqrt(1 + (0.6961663 * x.^2) ./ (x.^2 - 0.0684043^2) +...
...
% LAMBDA is in microns. Calculates refractive index for water at 21.5 ï¿½C.
%
...
n = sqrt(1 + (0.5689093832 * x.^2) ./ (x.^2 - 0.005110301794^2) +...
    (0.1719708856 .* x.^2) ./ (x.^2 - 0.018251801554^2) +...
    (0.02062501582 .* x.^2) ./ (x.^2 - 0.02624158904^2) +...    
    (0.1123965424 * x.^2) ./ (x.^2 - 10.67505178^2));
